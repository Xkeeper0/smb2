<?php
	...
	// Most of the work is manual now, so this automated tool is not useful
	echo "This tool is DEPRECATED. If you run it, you will overwrite a lot of manual work.\n";
	echo "If you understand that and wish to continue, edit this file and remove these comments.\n";
	die();

	// This is a tool to take a .ASM file generated by a particular
	// disassembly utility and turn it into a split bunch of assembly files
	// for use with asm6.
	// It will probably not work for other things.
	// You only need to use this if you updated the main
